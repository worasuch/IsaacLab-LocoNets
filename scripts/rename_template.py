...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        ...
        os.rename(
            os.path.join(root_dir_path, "source", "IsaacLab-LocoNets", "IsaacLab-LocoNets"),
            os.path.join(root_dir_path, "source", "IsaacLab-LocoNets", new_name),
        )
        os.rename(
            os.path.join(root_dir_path, "source", "IsaacLab-LocoNets"), os.path.join(root_dir_path, "source", new_name)
        )
